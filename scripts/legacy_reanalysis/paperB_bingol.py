...
def main():
    ...
    output = {
        'metadata': {
            'source': 'Atasoy Bingöl et al., IEEE Trans. Syst. Man Cybern. Syst., 2026, doi:10.1109/TSMC.2025.3649593',
            'timestamp': '1970-01-01 00:00:00',
            'runtime_sec': 0.0,
            'N_MAX_legacy_field': N_MAX,  # v1.0.7 normalization ceiling; unused since v1.1.0
