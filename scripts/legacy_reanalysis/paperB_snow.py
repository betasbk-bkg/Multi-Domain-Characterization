...
def run_PS_S2(ps_s1_results):
    ...
    print("  Utility: U(N) = λ·S(N) - (1-λ)·N/N_budget  [manuscript rule (1)]")
    print("=" * 68)
...
def main():
    ...
    output = {
        'metadata': {
            ...
            'runtime_sec': 0.0,
            'utility_definition': 'U(N) = λS(N) - (1-λ)N/N_budget [manuscript rule (1); S normalized against the component reference]',
