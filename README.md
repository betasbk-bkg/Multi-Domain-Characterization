# Paper B Full Reproduction Package v1.0.7
...
For a faster smoke test that skips the expensive Stage 8 bootstrap recomputation
...
- internal audit Markdown files; this README is the public procedure document
...
- `data/processed/` contains standardized item-level inputs derived from the admitted
  datasets for reproducibility of the Paper B analyses.
...
The verification script uses SHA-256 byte comparison.
